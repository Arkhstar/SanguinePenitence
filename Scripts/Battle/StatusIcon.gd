...
@onready var _label_mat : ShaderMaterial = _label.get_material()
...
func set_text_colors(main : Color, shadow : Color) -> void:
	_label_mat.set_shader_parameter("on", main)
	_label_mat.set_shader_parameter("off", shadow)
